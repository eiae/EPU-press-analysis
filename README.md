This repository contains the `html` report showing the empirical results (EPU indices and baseline IRF results) from the paper ["Using newspapers for textual indicators: which and
